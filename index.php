...
<html lang="en">
  ...
  <body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFD1E3" fill-opacity="1" d="M0,256L40,240C80,224,160,192,240,181.3C320,171,400,181,480,181.3C560,181,640,171,720,181.3C800,192,880,224,960,202.7C1040,181,1120,107,1200,90.7C1280,75,1360,117,1400,138.7L1440,160L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>    <section id="profil">
        <div class="container text-center">
          <div class="row mb-3">
            <div class="col">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFD1E3" fill-opacity="1" d="M0,96L40,101.3C80,107,160,117,240,133.3C320,149,400,171,480,154.7C560,139,640,85,720,58.7C800,32,880,32,960,69.3C1040,107,1120,181,1200,192C1280,203,1360,149,1400,122.7L1440,96L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
      <!-- Letak makassar -->
      <section id="letak">
        <div class="container">
          <div class="row">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFD1E3" fill-opacity="1" d="M0,128L40,106.7C80,85,160,43,240,69.3C320,96,400,192,480,202.7C560,213,640,139,720,112C800,85,880,107,960,101.3C1040,96,1120,64,1200,80C1280,96,1360,160,1400,192L1440,224L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
      <!-- tradisional -->
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>Pallu Basa merupakan makanan Makassar. Pallu basa juga terbuat dari jeroan sapi atau kerbau. </p>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>Palumara adalah sebuah hidangan tradisional khas Makassar, Sulawesi Selatan, Indonesia. Hidangan ini terkenal.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-3">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFD1E3" fill-opacity="1" d="M0,64L40,85.3C80,107,160,149,240,176C320,203,400,213,480,192C560,171,640,117,720,80C800,43,880,21,960,42.7C1040,64,1120,128,1200,160C1280,192,1360,192,1400,192L1440,192L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>      <section>
